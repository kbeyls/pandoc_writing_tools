...
% start of pandoc_writing_tools-specific template part
...
% end of pandoc_writing_tools-specific template part
$--
$-- section numbering
$--
$if(numbersections)$
...
Last updated: $if(LAST_UPDATED)$$LAST_UPDATED$$else$Unknown$endif$
